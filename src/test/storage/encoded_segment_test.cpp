...
TEST_F(EncodedSegmentTest, FrameOfReference) {
  ...
  EXPECT_EQ(for_segment->null_values()->at(0), false);
  EXPECT_EQ(for_segment->null_values()->at(1), true);
  EXPECT_EQ(for_segment->null_values()->at(7), true);
  EXPECT_EQ(for_segment->null_values()->at(16), false);
